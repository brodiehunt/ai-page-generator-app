...
export default function LearnSpokeGenerator() {
  return (
    <div className="flex flex-col pr-4 h-screen">
      <DocsPageHeader title="Learn Spoke Generator" />
      <DocsPagesContainer>
        <section>
          <DocsSectionHeader title="Introduction" />
          <div className="mb-4">
            <p>Welcome to the spoke generator docs. This page will cover:</p>
            <ol className="list-decimal pl-6">
              <li>What is spoke generator?</li>
              <li>
                What you will likely need before using the spoke generator
              </li>
              <li>
                The input fields, what they mean and how they are implemented
                into the spokes.
              </li>
              <li>How to implement your new spoke into your site.</li>
            </ol>
          </div>

          <DocsSectionHeader title="What is the spoke generator" />
          <div className="mb-4">
            <p className="mb-2">
              The spoke generator is a tool for building single spoke posts for
              your website.
            </p>
            <p className="mb-2">
              There are a few advantages of using a the single spoke generator
              over the all in one generator. They include:
            </p>
            <ul className="list-disc pl-6 mb-2">
              <li>
                The ability to choose your own title and slug from the get-go
              </li>
              <li>
                ...
                because the assumption is none of the other spokes will be live
          ...
          <div className="mb-4">
            <p className="mb-2">
              To use the spoke generator effectively you will need:
            </p>
            <ul className="list-disc pl-6 mb-2">
              ...
              <li>
                The title, slug, and keyphrase for the spoke you want to build.
                This could come from independent research, or you could use the{" "}
                <Link
                  className="underline font-medium text-custom-primary"
                  href="/dashboard/longtail-generator"
                >
                  Longtail Generator Tool
                </Link>{" "}
                for ideation.
              </li>
              <li>
                The title, full url and seo keyphrase of other spokes that
                already exist on the website if you want this blog to link to
                them.
              </li>
              <li>
          ...
          <div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <img
                src="/docs/spokeGenerator/blogInfo.webp"
                alt="Website info screenshot"
                className="max-h-[200px]"
              />
              <p className="mb-2">
                This section exists so you can provide context about the spoke
                that you want to generate. There are 5 fields.
              </p>
              <ul className="mb-2 pl-6 list-decimal">
                <li>
                  <strong>Spoke Title:</strong> The title of the longtail spoke
                  you want to generate. Eg: How can SEO help small construction
                  businesses.
                </li>
                <li>
                  <strong>Spoke Slug:</strong> The slug of the longtail spoke
                  you want to generate. Eg:
                  how-can-seo-help-small-construction-businesses.
                </li>
                <li>
          ...
          <div className="mb-4">
            ...
            <img
              src="/docs/spokeGenerator/hubInfo.webp"
              alt="Website info screenshot"
              className="max-h-[200px]"
            />
            <p className="mb-2">
            ...
            <ul className="mb-2 pl-6 list-decimal">
              <li>
                <strong>Hub Title:</strong> The title of the hub page that this
                spoke will belong to. Eg: Small Business.
              </li>
              <li>
                <strong>Spoke Url:</strong> The full url of this existing hub
                page Eg: https://cogbranding.com.au/small-business
              </li>
            </ul>
          </div>
          <div className="mb-4">
            <h4 className="mb-2 font-medium text-xl text-custom-primary">
              Step 4: Related Spokes and Backlinks
            </h4>
            <img
            ...
            />
            <p className="mb-2">
              This section exists so you can provide context about other spokes
              that exist within this hub and spoke group aswell as high D.A
              backlinks. This data is used to provide the AI model with context
              of what its related spokes may be about, so it can shape some
              content to be relevant to these spokes and then link them. For
              each blog, there will be one high D.A backlink included in the
              introduction section, and another including in the conclusion
              section.
            </p>
            <ul className="mb-2 pl-6 list-decimal">
              <li>
